class certs::gutterball(
  ...
  $amqp_truststore        = $::certs::params::gutterball_amqp_truststore,
  $amqp_keystore          = $::certs::params::gutterball_amqp_keystore,
  $amqp_store_dir         = $::certs::params::gutterball_amqp_store_dir,

) inherits certs::params {
  $keystore_alias = 'gutterball'
  $ca_key = $::certs::ca_key
  $ca = $::certs::ca_cert_stripped
  $key = "${::certs::gutterball_certs_dir}/gutterball.key"
  $cert = "${::certs::gutterball_certs_dir}/gutterball.crt"
